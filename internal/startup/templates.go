...
func GenerateopenshiftBenchmarkFiles() ([]utils.FilesInfo, error) {
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.ConfigureSoftwareUpdates, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.ConfigureSudo, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.FilesystemIntegrityChecking, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.AdditionalProcessHardening, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.MandatoryAccessControl, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.WarningBanners, err.Error())
	}
	fileInfo = append(fileInfo, utils.FilesInfo{Name: common.WarningBanners, Data: wb})
	//8
	eu, err := box.FindString(common.EnsureUpdates)
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.EnsureUpdates, err.Error())
	}
	fileInfo = append(fileInfo, utils.FilesInfo{Name: common.EnsureUpdates, Data: eu})
	//9
	is, err := box.FindString(common.InetdServices)
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.InetdServices, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.SpecialPurposeServices, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.ServiceClients, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.NonessentialServices, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.NetworkParameters, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.NetworkParametersHost, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.TCPWrappers, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.FirewallConfiguration, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.ConfigureLogging, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.EnsureLogrotateConfigured, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.EnsureLogrotateAssignsAppropriatePermissions, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.ConfigureCron, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.SSHServerConfiguration, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.ConfigurePam, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.UserAccountsAndEnvironment, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.RootLoginRestrictedSystemConsole, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.EnsureAccessSuCommandRestricted, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.SystemFilePermissions, err.Error())
	}
	...
	if err != nil {
		return []utils.FilesInfo{}, fmt.Errorf("faild to load openshift benchmarks audit tests %s %s", common.UserAndGroupSettings, err.Error())
	}
