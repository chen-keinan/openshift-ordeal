...
type OutputGenerator func(at []*models.SubCategory, log *logger.OsOrdealLogger)

//PrintOutput print audit test result to console
func PrintOutput(auditTests []*models.SubCategory, outputGenerator OutputGenerator, log *logger.OsOrdealLogger) {
